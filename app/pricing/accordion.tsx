...
const FAQAccordion: React.FC = () => {
  ...
  return (
    <section className="py-12 px-4 font-sans">
     ...
     {/* MOBILE & TABLET (343px tablet, 342px mobile) */}
<div className="lg:hidden flex flex-col md:flex-row md:gap-2 items-center md:items-start">

  {/* Title stays top */}
  <h1 className="text-[32px] font-bold leading-tight text-center mb-8 md:hidden max-w-[343px]">
    WorkFotos Pricing <span className="text-[#007bff]">FAQs</span>
  </h1>

  {/* IMAGE — mobile: 342px, tablet: 343px */}
  <div className="w-[342px] md:w-[343px] md:mb-0 mb-8">
    <Image
      src="/accordion1.jpg"
  ...
  {/* ACCORDION — mobile: 342px, tablet: 343px */}
  <div className="space-y-4 w-[342px] md:w-[343px]">
    {faqs.map((item, index) => (
      <details
        key={index}
