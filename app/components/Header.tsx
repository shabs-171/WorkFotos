...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
      ...
      <div className="container-87 flex items-center justify-between h-[80px] md:h-[100px]">
        ...
        <div className="hidden xl:flex items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            <button className={`border px-5 py-2 rounded-full font-semibold text-[14px] ${
              isMenuOpen || isScrolled
            ...
            <button className={`px-5 py-2 rounded-full font-semibold text-[14px] ${
              isMenuOpen || isScrolled
        ...
        {/* Mobile Menu Button - Instant blue background */}
        <button
        ...
        >
          ...
          <span className={`w-6 h-0.5 bg-white transition-all duration-300 mt-1.5 ${
      ...
      {/* Mobile Menu - Instant blue background */}
